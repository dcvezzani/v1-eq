...
const TOKEN_PATH = 'dcvezzani-gmail-token.json';
...
<p>Good luck, <span style='color: blue;'>Dave</span>!</p>
`

  const emailPlain = `From: David Vezzani <dcvezzani@gmail.com>\r\nTo: Dave V <dave@reliacode.com>\r\nSubject: Wonderful Test\r\nDate: Sun, 29 Jul 2018 07:15:00 -0700\r\nMessage-ID: <1234@local.machine.example>\r\nContent-Type: text/html; charset=utf-8\r\n\r\n<h3> Greetings, program </h3>\r\n${message}`
  const raw = btoa(emailPlain).replace(/\+/g, '-').replace(/\//g, '_').replace(/\=+$/, '');
